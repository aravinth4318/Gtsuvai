...
class HotelDescriptionApi extends StatefulWidget {
  final int? restaurantId;
   HotelDescriptionApi({ Key?key, required this.restaurantId}): super(key: key);



  @override
  State<HotelDescriptionApi> createState() => _HotelDescriptionApiState();
}

class _HotelDescriptionApiState extends State<HotelDescriptionApi> {
                              ...
                              child: Center(
                                  child: Column(
                                    ...
                                    builder: ( context, snapshot) {
                                      ...
                                      //return Text(snapshot.data![index].restaurantName.toString());
                                      //List<RestaurantDtlsById> list=snapshot.data!;
                                      return Text(snapshot.data![0].restaurantName.toString());
                                ...
                                child: FutureBuilder(
                                  ...
                                  builder: ( context,snapshot) {
                                    ...
                                    return  Text(snapshot.data![0].address.toString(),
                                      style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontSize: 18,fontFamily: "Outfit-SemiBold"),);
                                  },
                                                            ...
                                                            children: [
                                                              Padding(
                                                                ...
                                                                child: Container(
                                                                  ...
                                                                  decoration: BoxDecoration(
                                                                      image: DecorationImage(
                                                                          image: NetworkImage(snapshot.data![0].restaurantImage.toString()),fit: BoxFit.fill
                                                                      ),
