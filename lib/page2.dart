                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: Text("163 VRG Complex NSR Road Saibaba Colony"
                                "Coimbbatore",style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontSize: 18,fontFamily: "Outfit-SemiBold"),),
                          ),
                        ),
                      ],
                    ),
                                            ...
                                            return Column(crossAxisAlignment: CrossAxisAlignment.start,
                                              children: [
                                                ...
                                                Row(children: [
                                                  ...
                                                  SizedBox(width: 150,),
                                                  GestureDetector(
                                                    onTap: (){_launchGoogleMapsDirections( 10.998440,76.976533);},
